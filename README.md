...
**当前版本：[1.1.2](https://github.com/ChisaAlter/codebuddy-desktop/releases/tag/v1.1.2)** · [变更说明](./RELEASE_NOTES.md) · [全部发行版](https://github.com/ChisaAlter/codebuddy-desktop/releases)（已发布的 Windows 安装包可能落后于代码版本，以 Releases 页为准）
